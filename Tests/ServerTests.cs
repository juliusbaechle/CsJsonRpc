...
namespace Tests
{
    ...
    public sealed class ServerTests
    {
        ...
        public async Task CallMethods()
        {
            ...
            server.Add("Subtract", (int minuend, int subtrahend) => { return minuend - subtrahend; }, ["Minuend", "Subtrahend"]);
        ...
        public async Task CallMethodWithNullValue()
        {
            var registry = new MethodRegistry();
            var server = new Server(registry);
            server.Add("HandleNull", (JsonObject? obj) => { return; }, ["Object"]);
        ...
        public async Task CallNotification()
        {
            ...
            server.Add("SetParam", (List<int> a_params) => { recv_params = a_params; });
        ...
        public async Task InvalidRequests()
        {
            ...
            json = JsonDocument.Parse(server.HandleRequest(request)).Deserialize<JsonObject>();
        ...
        public async Task ExceptionInMethod()
        {
            var registry = new MethodRegistry();
            var server = new Server(registry);
            server.Add("ThrowException", () => { throw new ArgumentNullException(); });
        ...
        public async Task HandleBatchRequest()
        {
            var registry = new MethodRegistry();
            var server = new Server(registry);
            server.Add("Add", (int a, int b) => { return a + b; });
            server.Add("Increment", (int a) => { return a + 1; });
            ...
            var json = JsonDocument.Parse(server.HandleRequest(req_str)).Deserialize<JsonArray>();
